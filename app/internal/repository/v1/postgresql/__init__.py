...
from app.internal.repository.v1.postgresql.delivery import DeliveryRepository
...
from app.internal.repository.v1.postgresql.recipient import RecipientRepository
...
class Repositories(containers.DeclarativeContainer):
    ...
    delivery_repository = providers.Factory(DeliveryRepository)
    recipient_repository = providers.Factory(RecipientRepository)
